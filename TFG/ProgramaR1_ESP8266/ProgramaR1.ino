...
const char* mqtt_topic = "L2_R1"; //robot1
const char* mqtt_ID = "ESP-client1";
...
void setup() {
  ...
  delay(15000); //para evitar que se mande un 0 y haya que resetear el modulo
  // conectarse al wifi
  ...
  client.connect("mqtt_ID "); //id del primer robot
}
